...
func (p *DouyinFavoriteActionResponse) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "base_rasp", thrift.STRUCT, 1)
	offset += p.BaseRasp.FastWriteNocopy(buf[offset:], binaryWriter)
	offset += bthrift.Binary.WriteFieldEnd(buf[offset:])
	return offset
}
...
func (p *DouyinFavoriteActionResponse) field1Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("base_rasp", thrift.STRUCT, 1)
	l += p.BaseRasp.BLength()
	l += bthrift.Binary.FieldEndLength()
	return l
}
...
func (p *DouyinFavoriteListResponse) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "base_rape", thrift.STRUCT, 1)
	offset += p.BaseRape.FastWriteNocopy(buf[offset:], binaryWriter)
	offset += bthrift.Binary.WriteFieldEnd(buf[offset:])
	return offset
}
...
func (p *DouyinFavoriteListResponse) field1Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("base_rape", thrift.STRUCT, 1)
	l += p.BaseRape.BLength()
	l += bthrift.Binary.FieldEndLength()
	return l
}
